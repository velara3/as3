...
var RoadHouse_1 = require("./RoadHouse");
...
ipcMain.on("callCommand", function (event, item) {
    return __awaiter(this, void 0, void 0, function () {
        var roadHouse, output;
        return __generator(this, function (_a) {
            console.log("Main process received message");
            roadHouse = new RoadHouse_1.RoadHouse("Hello");
            console.log("Is running:" + roadHouse.isRunning);
            output = "Message received. " + process.release.name + " " + process.version;
